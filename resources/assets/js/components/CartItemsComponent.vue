    ...
    <div class='container content-holder'>
      <div class="row">
        <div class="content-area">
            ...
            <div class="details" v-for="(cart, index) in carts">
                <div class="item-detail">
                    <div class="itemImg">
                        <a :href="url+'/products/'+cart.product.slug" class="thumbnail">
                            <img :src="url+'/images/products/'+cart.image" class="blur-up lazyload">
                        </a>
                    </div>
                    <div class="item-opts">
                        <div class="item-title">
                            <a :href="url+'/products/'+cart.product.slug" class="">
                                {{ cart.product.title }}
                            </a>
                        </div>
                        <div class="prodPrice">
                        ...
                        <div class="delivery-detail">
                            Delivery in {{ cart.product.delivery_time }} days..!
                        </div>
                        <div class="qnt">
                ...
                <div class="cart-actions">
                    <button type="submit" class="action" @click="deleteCartItem(cart.id)">
...
<div class="empty-holder" v-else>
    ...
    <div class="emptyContent">
        ...
        <div class="add-msg">
            <a :href="url+'/wishlist'">+ Add items from your wishlist.</a>
        </div>
        <div class="GoToHome">
            <a :href="url+'/'" class="goHome">
                shop now
            </a>
        </div>
    </div> -->
<!--     <div class="alert alert-warning">
    <p>
        <strong>You have no item in your cart !!</strong>
    </p>
  </div> -->
...
<div class="price-detail" v-if="carts.length">
    ...
    <div class="priceArea">
        ...
        <div class="">
            <p>
                <a :href="url+'/checkout'" class="procBtn">PROCEED</a>
            </p>
        </div>
        <div class="clearfix"></div>
    </div>
...
<script>
  ...
  methods: {
      updateQuantity(cart_id, index){
        var app = this;
        axios.post(app.url+'/api/carts/quantity-update/'+cart_id, {
    ...
    deleteCartItem(cart_id){
        var app = this;
        axios.post(app.url+'/api/carts/delete/'+cart_id)
        .then((response) => {
            console.log(response)
            if (response.data.success == true) {
                app.generateNotification(response.data.message, 'success', 5000);
    ...
    setTotalAmounts(){
        var app = this;
        axios.get(app.url+'/api/carts/total-amounts')
        .then((response) => {
    ...
    setTotalItems(){
        var app = this;
        axios.get(app.url+'/api/carts/total')
        .then((response) => {
