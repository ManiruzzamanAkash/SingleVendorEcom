<template>
	<div class="container mt-4">
		...
		<div class="row">
			<div class="col-sm-9">
				<div
					class="card card-body p-3 table-responsive"
				...
				>
					<table class="table table-cart">
						...
						<tbody>
							<tr v-for="(cart, index) in wishlists" :key="index">
								<td>{{ index + 1 }}</td>
								<td>
									<a :href="url + '/products/' + cart.product.slug"
								...
								<td>
									<button
										...
										@click="deleteWishlistItem(cart.id)"
									>
...
export default {
	...
	methods: {
		deleteWishlistItem(cart_id) {
			var app = this;
			axios
				.post(app.url + "/api/wishlists/delete/" + cart_id)
				.then((response) => {
