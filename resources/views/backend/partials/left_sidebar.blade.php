  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="coupon-pages">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.coupons') }}">Manage Coupons</a></li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="review-pages">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.reviews') }}">Manage Reviews</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="reports-pages">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.reports') }}">All Reports</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.report.sell_report') }}">Sell Report</a></li>
        </ul>
      </div>
    </li>
