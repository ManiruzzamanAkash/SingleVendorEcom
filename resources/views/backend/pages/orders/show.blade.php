  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('admin.order.delivery', $order->id) }}" class="form-inline" style="display: inline-block!important;" method="post">
          @csrf
          @if ($order->delivery_status)
          <input type="submit" value="Delivery compleate " class="btn btn-danger">
          @else
          <input type="submit" value="Delivery pending" class="btn btn-success">
          @endif
        </form>
