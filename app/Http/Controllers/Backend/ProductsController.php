...
class ProductsController extends Controller
{
	...
	public function getProductImages($id)
	{
		...
		if (!empty($product)) {
			return view('backend.pages.product.partials.product-image', compact('product'));
		}
		return null;
	}
	...
	public function deleteImage($id)
	{
		...
		if (!empty($productImage)) {
			UploadHelper::deleteFile('images/products/' . $productImage->image);
			$productImage->delete();
			session()->flash('success', 'Product image has deleted successfully !');
		} else {
			session()->flash('success', 'Product image not found !');
		}
